...
This installs a newer version of sudo, because there's a bug with the one we have. If it asks about replacing the sudoers file, I would keep the one you have (that's what I did, at least)

Replace /etc/apache2/sites-available/port443 with the one attached to this email
...
Edit /etc/hosts so that the IP next to your machine (internerd#.e.ecovate.com) is your IP rather than 127.0.0.1
